class AuthBlockProfiles extends HTMLElement {
  constructor() {
    super();
    ...
    this.render = async () => {
      ...
      TEMPLATE_CONTENT = `
        ...
        <div>
          ...
          <auth-block-profile scheme="${scheme}" profile-id="${schemeProfile && schemeProfile.id}"></auth-block-profile>
        </div>
      `;
...
customElements.define('auth-block-profiles', AuthBlockProfiles);
